...
/**
 * Test class for AllDeviceDetailsServiceV4.
 */
public class AllDeviceDetailsServiceV4Test {
    ...
    @InjectMocks
    private AllDeviceDetailsServiceV4 allDeviceDetailsServiceV4;
    ...
    public void findAllFactoryDataTest_throwException() {
        ...
        DeviceDetailsDtoV4 dto = new DeviceDetailsDtoV4("1", "1", null, null, null);

        Mockito.doReturn(0L).when(deviceInfoQueryFindDaoV4)
        ...
        allDeviceDetailsServiceV4.findAllFactoryData(dto, "9900008624711007");
    }
    ...
    public void findAllFactoryDataTest() {
        ...
        Mockito.doReturn(st).when(deviceInfoQueryFindDaoV4)
            .constructFetchAggregateFactoryData(Mockito.any(), Mockito.any());
        Mockito.when(deviceInfoQueryFindDaoV4.constructFetchFactoryData(Mockito.any(), Mockito.any(), Mockito.anyInt(),
            Mockito.anyInt(), Mockito.any(), Mockito.any())).thenReturn(factoryDataList);
        Mockito.doReturn(RETURN_VALUE).when(deviceInfoQueryFindDaoV4)
            .constructFetchTotalFactoryDataForDeviceDetails(Mockito.any(), Mockito.any());
        Mockito.doReturn(false).when(config)
            .getBooleanValue(DeviceInfoQueryProperty.ENABLE_DEVICE_SUBSCRIPTION_DETAILS);
        ...
        Assertions.assertEquals(RETURN_VALUE,
            deviceInfoQueryFindDaoV4.constructFetchTotalFactoryDataForDeviceDetails(Mockito.any(), Mockito.any()));
    }
