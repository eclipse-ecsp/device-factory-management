...
/**
 * This enum represents the properties used for querying device information.
 * It implements the EnvConfigProperty interface.
 */
public enum DeviceInfoQueryProperty implements EnvConfigProperty {
    ...
    /**
     * Constructs a DeviceInfoQueryProperty with the specified name in the file and default value.
     * The type is set to PUBLIC.
     *
     * @param nameInFile   the name of the property in the file
    ...
    /**
     * Constructs a DeviceInfoQueryProperty with the specified name in the file, default value, and type.
     *
     * @param nameInFile   the name of the property in the file
     * @param defaultValue the default value of the property
