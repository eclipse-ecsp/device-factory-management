...
/**
 * Represents a request object for device factory data.
 */
public class DeviceInfoFactoryDataRequest implements Serializable {
    ...
    /**
     * Returns a string representation of the `DeviceInfoFactoryDataRequest` object.
     *
     * @return A string representation of the object, including the values of its fields.
     */
    @Override
    public String toString() {
        return "DeviceInfoFactoryDataRequest [manufacturingDate=" + manufacturingDate + ", model=" + model + ", imei="
            + imei
            ...
            + ", packageSerialNumber="
            + packageSerialNumber + ", vin=" + vin + ", chassisNumber=" + chassisNumber + ", plant=" + plant
            + ", productionWeek="
            + productionWeek + ", vehicleModelYear=" + vehicleModelYear + ", friendlyName=" + friendlyName + "]";
    }
