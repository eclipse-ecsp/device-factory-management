...
/**
 * This class represents a data access object for managing vehicle factory data in the SwmIntegration system.
 * It extends the AbstractDeviceFactoryDataDao class and provides methods for creating devices.
 */
@Repository
public class SwmIntegrationVehicleFactoryDataDao extends AbstractDeviceFactoryDataDao {
    @Autowired
     ...
     *
     * @param deviceFactoryDataDto The device factory data DTO containing the necessary information for device creation.
     * @param userId The ID of the user performing the device creation.
    ...
    public boolean createDevice(DeviceFactoryDataDto deviceFactoryDataDto, String userId) {
        ...
        if (keyHolder.getKeys() != null
            && (deviceFactoryDataDto.getVin() != null && !deviceFactoryDataDto.getVin().isEmpty())) {
