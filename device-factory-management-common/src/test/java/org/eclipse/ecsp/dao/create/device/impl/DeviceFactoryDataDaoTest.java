...
public class DeviceFactoryDataDaoTest {
    ...
    @InjectMocks
    DeviceFactoryDataDao deviceFactoryDataDao;
    ...
    public void createDevice() {
        ...
        deviceFactoryDataDao.createDevice(factoryDatadto, userdId);
        Assertions.assertTrue(deviceFactoryDataDao.createDevice(factoryDatadto, userdId));
    }
}
