...
/**
 * Test class for GuestUserVehicleFactoryDataDao.
 */
public class GuestUserVehicleFactoryDataDaoTest {
    public static final long ID = 4L;
    public static final int FACTORY_ID = 46;

    @InjectMocks
    GuestUserVehicleFactoryDataDao guestUserVehicleFactoryDataDao;
    ...
    public void createDevice() {
        ...
        guestUserVehicleFactoryDataDao.createDevice(factoryDatadto, userId);
        Assertions.assertFalse(guestUserVehicleFactoryDataDao.createDevice(factoryDatadto, userId));
    }
    ...
    public void createDevice1() {
        ...
        Mockito.doReturn(deviceInfoFactoryData).when(factoryDao).findByFactoryId(FACTORY_ID);
        Mockito.doNothing().when(vinDetailsDao).insert(0L, userId);
        DeviceFactoryDataDto factoryDatadtolocal = factoryDatadto;
        factoryDatadtolocal.setVin(null);
        guestUserVehicleFactoryDataDao.createDevice(factoryDatadto, userId);
        Assertions.assertFalse(guestUserVehicleFactoryDataDao.createDevice(factoryDatadto, userId));
    }
}
