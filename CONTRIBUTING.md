...
`eclipse-ecsp/device-factory-management` up to date and always improving! There are a few guidelines that we need
contributors to follow to keep the project consistent, as well as allow us to keep
maintaining `eclipse-ecsp/device-factory-management` in a reasonable amount of time.
...
1. Please make sure there is no [open issue](https://github.com/eclipse-ecsp/device-factory-management/issues) yet.
...
- Submit a pull request from your topic branch to the [main](https://github.com/eclipse-ecsp/device-factory-management) branch on the `eclipse-ecsp/device-factory-management` repository.
...
- Ensure that the PR is tagged with related [issue](https://github.com/eclipse-ecsp/device-factory-management/issues) it intends to resolve.
